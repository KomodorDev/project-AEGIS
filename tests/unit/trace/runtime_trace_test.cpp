...
[[nodiscard]] model::Price create_price_or_throw(std::int64_t coefficient, std::uint8_t scale) {
...
create_runtime_policy_or_throw(std::uint32_t runtime_trace_capacity = 256U,
...
[[nodiscard]] const runtime::RuntimePolicy& configured_runtime_policy_or_throw() {
  static const runtime::RuntimePolicy policy = create_runtime_policy_or_throw();
  return policy;
}

// --------------------------------------------------------
// Build one complete source identity shared by market-runtime event fixtures.
[[nodiscard]] trace::RuntimeTraceSource create_trace_source_or_throw() {
  return trace::RuntimeTraceSource::from_runtime_source(
      configured_runtime_policy_or_throw().sources().front());
}

// --------------------------------------------------------
// Build complete accepted-input context before selecting an event-specific observation shape.
[[nodiscard]] trace::RuntimeTraceFields create_input_fields_or_throw() {
  trace::RuntimeTraceFields fields;
  fields.source = create_trace_source_or_throw();
  fields.admission_ordinal = create_ordinal_or_throw<model::AdmissionOrdinal>(7U);
  fields.turn_ordinal = create_ordinal_or_throw<model::TurnOrdinal>(3U);
  fields.session_epoch = model::SessionEpoch{2U};
  fields.source_sequence = model::SequenceNumber{41U};
  fields.receive_sequence = create_ordinal_or_throw<model::ReceiveSequence>(9U);
  fields.metadata_revision = create_revision_or_throw<model::InstrumentMetadataRevision>(6U);
  fields.book_generation = create_ordinal_or_throw<model::BookGeneration>(1U);
  fields.book_revision = create_ordinal_or_throw<model::BookRevision>(4U);
...
create_envelope_disposition_fields_or_throw(trace::RuntimeInputDisposition disposition,
                                            trace::RuntimeMarketState state) {
  auto fields = create_input_fields_or_throw();
...
[[nodiscard]] trace::RuntimeTraceFields create_source_discontinuity_fields_or_throw() {
  auto fields = create_input_fields_or_throw();
...
[[nodiscard]] trace::RuntimeTraceFields create_market_callback_fields_or_throw() {
  auto fields = create_input_fields_or_throw();
  fields.callback_ordinal = create_ordinal_or_throw<model::CallbackOrdinal>(2U);
  fields.bot_id = parse_identifier_or_throw<model::BotId>("bot.deribit-btc-perpetual-reference");
  ...
  fields.best_bid = create_price_or_throw(6'500'000, 2U);
  fields.best_ask = create_price_or_throw(6'500'050, 2U);
  return fields;
}

// --------------------------------------------------------
// Build an attributed Ready transition for both owner and strategy state observations.
[[nodiscard]] trace::RuntimeTraceFields create_state_transition_fields_or_throw(bool callback) {
  auto fields = create_input_fields_or_throw();
  fields.input_disposition = trace::RuntimeInputDisposition::Unspecified;
  fields.previous_state = trace::RuntimeMarketState::Synchronizing;
  if (callback) {
    fields.callback_ordinal = create_ordinal_or_throw<model::CallbackOrdinal>(1U);
    fields.bot_id = parse_identifier_or_throw<model::BotId>("bot.deribit-btc-perpetual-reference");
    fields.subscription_id =
        parse_identifier_or_throw<model::SubscriptionId>("subscription.deribit-btc-perpetual-book");
  }
...
[[nodiscard]] trace::RuntimeTraceFields
create_initial_state_transition_fields_or_throw(bool callback) {
  trace::RuntimeTraceFields fields;
  fields.source = create_trace_source_or_throw();
  fields.turn_ordinal = create_ordinal_or_throw<model::TurnOrdinal>(1U);
...
[[nodiscard]] trace::RuntimeTraceFields create_owner_reentry_fields_or_throw() {
  trace::RuntimeTraceFields fields;
  fields.turn_ordinal = create_ordinal_or_throw<model::TurnOrdinal>(3U);
...
TEST_CASE("runtime trace event vocabulary and shapes are explicit", "[trace][runtime][unit]") {
  ...
  trace::RuntimeTraceSink sink{configured_runtime_policy_or_throw()};
  REQUIRE(sink.validate_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
                                     create_input_fields_or_throw()));
  CHECK(sink.record_count() == 0U);
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
                                   create_input_fields_or_throw()));
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::MarketStateTransition,
                                   create_state_transition_fields_or_throw(false)));
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::MarketCallback,
                                   create_market_callback_fields_or_throw()));
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::StateCallback,
                                   create_state_transition_fields_or_throw(true)));
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::ReentryDetected,
                                   create_owner_reentry_fields_or_throw()));
  ...
  trace::RuntimeTraceSink initial{configured_runtime_policy_or_throw()};
  REQUIRE(initial.append_trace_record(trace::RuntimeTraceEventKind::MarketStateTransition,
                                      create_initial_state_transition_fields_or_throw(false)));
  REQUIRE(initial.append_trace_record(trace::RuntimeTraceEventKind::StateCallback,
                                      create_initial_state_transition_fields_or_throw(true)));
  ...
  auto owner_resynchronization = create_initial_state_transition_fields_or_throw(false);
  owner_resynchronization.previous_state = trace::RuntimeMarketState::Synchronizing;
  REQUIRE(initial.append_trace_record(trace::RuntimeTraceEventKind::MarketStateTransition,
                                      std::move(owner_resynchronization)));
  auto owner_resynchronization_callback = create_initial_state_transition_fields_or_throw(true);
  ...
  auto callback_reentry = create_owner_reentry_fields_or_throw();
  callback_reentry.callback_ordinal = create_ordinal_or_throw<model::CallbackOrdinal>(4U);
  callback_reentry.bot_id =
      parse_identifier_or_throw<model::BotId>("bot.deribit-btc-perpetual-reference");
  callback_reentry.subscription_id =
      parse_identifier_or_throw<model::SubscriptionId>("subscription.deribit-btc-perpetual-book");
  trace::RuntimeTraceSink attributed_reentry{configured_runtime_policy_or_throw()};
  REQUIRE(attributed_reentry.append_trace_record(trace::RuntimeTraceEventKind::ReentryDetected,
...
TEST_CASE("runtime input dispositions enforce deterministic context profiles",
  ...
  trace::RuntimeTraceSink sink{configured_runtime_policy_or_throw()};
  REQUIRE(sink.append_trace_record(
      trace::RuntimeTraceEventKind::InputDisposition,
      create_envelope_disposition_fields_or_throw(trace::RuntimeInputDisposition::MalformedRejected,
                                                  trace::RuntimeMarketState::Invalid)));
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
                                   create_envelope_disposition_fields_or_throw(
                                       trace::RuntimeInputDisposition::UnsupportedRejected,
                                       trace::RuntimeMarketState::Invalid)));
  REQUIRE(sink.append_trace_record(
      trace::RuntimeTraceEventKind::InputDisposition,
      create_envelope_disposition_fields_or_throw(trace::RuntimeInputDisposition::SessionReset,
                                                  trace::RuntimeMarketState::Synchronizing)));
  REQUIRE(sink.append_trace_record(
      trace::RuntimeTraceEventKind::InputDisposition,
      create_envelope_disposition_fields_or_throw(trace::RuntimeInputDisposition::StalenessChecked,
  ...
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
                                   create_source_discontinuity_fields_or_throw()));
  auto structural_rejection = create_input_fields_or_throw();
  ...
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
                                   std::move(structural_rejection)));

  // ++++++++++++++++++++++++++++++++++++++++
  // Sanitized state records may retain the same envelope-only context without exposing raw input.
  auto state_transition = create_envelope_disposition_fields_or_throw(
  ...
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::MarketStateTransition,
                                   state_transition));
  state_transition.callback_ordinal = create_ordinal_or_throw<model::CallbackOrdinal>(3U);
  state_transition.bot_id =
      parse_identifier_or_throw<model::BotId>("bot.deribit-btc-perpetual-reference");
  state_transition.subscription_id =
      parse_identifier_or_throw<model::SubscriptionId>("subscription.deribit-btc-perpetual-book");
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::StateCallback,
                                   std::move(state_transition)));
  CHECK(sink.record_count() == 9U);

  // ++++++++++++++++++++++++++++++++++++++++
  // A rejection before the first snapshot carries neither half nor a fabricated whole book ID.
  auto pre_snapshot_discontinuity = create_source_discontinuity_fields_or_throw();
  pre_snapshot_discontinuity.book_generation.reset();
  pre_snapshot_discontinuity.book_revision.reset();
  trace::RuntimeTraceSink pre_snapshot{configured_runtime_policy_or_throw()};
  REQUIRE(pre_snapshot.append_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
  ...
  trace::RuntimeTraceSink unchanged{configured_runtime_policy_or_throw()};
  auto stale_duplicate = create_input_fields_or_throw();
  ...
  REQUIRE(unchanged.append_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
                                        std::move(stale_duplicate)));
  auto invalid_duplicate = create_input_fields_or_throw();
  ...
  REQUIRE(unchanged.append_trace_record(
      trace::RuntimeTraceEventKind::InputDisposition,
      create_envelope_disposition_fields_or_throw(trace::RuntimeInputDisposition::SessionIgnored,
                                                  trace::RuntimeMarketState::Ready)));
  REQUIRE(unchanged.append_trace_record(
      trace::RuntimeTraceEventKind::InputDisposition,
      create_envelope_disposition_fields_or_throw(trace::RuntimeInputDisposition::StalenessChecked,
  ...
  trace::RuntimeTraceSink rejected{configured_runtime_policy_or_throw()};
  auto malformed_with_parsed_context = create_input_fields_or_throw();
  ...
  CHECK_FALSE(rejected.append_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
                                           std::move(malformed_with_parsed_context)));

  auto stale_with_parsed_context = create_input_fields_or_throw();
  ...
  auto discontinuity_with_receive = create_source_discontinuity_fields_or_throw();
  discontinuity_with_receive.receive_sequence =
      create_ordinal_or_throw<model::ReceiveSequence>(10U);
  CHECK_FALSE(rejected.append_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
                                           std::move(discontinuity_with_receive)));

  auto structural_without_metadata = create_input_fields_or_throw();
  ...
  auto state_without_attempt = create_state_transition_fields_or_throw(false);
  state_without_attempt.admission_ordinal.reset();
  CHECK_FALSE(rejected.append_trace_record(trace::RuntimeTraceEventKind::MarketStateTransition,
                                           std::move(state_without_attempt)));

  auto stale_without_book = create_input_fields_or_throw();
  ...
  auto revision_before_generation = create_input_fields_or_throw();
  revision_before_generation.book_generation = create_ordinal_or_throw<model::BookGeneration>(5U);
  revision_before_generation.book_revision = create_ordinal_or_throw<model::BookRevision>(4U);
  CHECK_FALSE(rejected.append_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
  ...
  const auto foreign_policy =
      create_runtime_policy_or_throw(256U, "source.deribit-btc-perpetual-secondary");
  auto foreign_source = create_input_fields_or_throw();
  foreign_source.source =
      trace::RuntimeTraceSource::from_runtime_source(foreign_policy.sources().front());
  const auto foreign_validation = rejected.validate_trace_record(
      trace::RuntimeTraceEventKind::InputDisposition, foreign_source);
  ...
  const auto reject_transition_and_callback = [&](trace::RuntimeTraceFields fields) {
    CHECK_FALSE(rejected.validate_trace_record(trace::RuntimeTraceEventKind::MarketStateTransition,
                                               fields));
    fields.callback_ordinal = create_ordinal_or_throw<model::CallbackOrdinal>(8U);
    fields.bot_id = parse_identifier_or_throw<model::BotId>("bot.deribit-btc-perpetual-reference");
    fields.subscription_id =
        parse_identifier_or_throw<model::SubscriptionId>("subscription.deribit-btc-perpetual-book");
    CHECK_FALSE(
        rejected.validate_trace_record(trace::RuntimeTraceEventKind::StateCallback, fields));
  };

  auto synchronizing_to_stale_update = create_state_transition_fields_or_throw(false);
  ...
  auto ready_to_synchronizing_update = create_state_transition_fields_or_throw(false);
  ...
  auto synchronizing_to_invalid_owner = create_initial_state_transition_fields_or_throw(false);
  ...
  auto envelope_same_synchronizing = create_envelope_disposition_fields_or_throw(
...
TEST_CASE("runtime trace rejects ambiguous fixed-field combinations", "[trace][runtime][unit]") {
  ...
  trace::RuntimeTraceSink sink{configured_runtime_policy_or_throw()};
  auto stale_callback = create_market_callback_fields_or_throw();
  stale_callback.state = trace::RuntimeMarketState::Stale;
  const auto stale = sink.append_trace_record(trace::RuntimeTraceEventKind::MarketCallback,
                                              std::move(stale_callback));
  REQUIRE_FALSE(stale);
  CHECK(stale.error().context.field == "runtime_trace.market_callback");

  auto crossed_book = create_market_callback_fields_or_throw();
  crossed_book.best_ask = crossed_book.best_bid;
  const auto crossed = sink.append_trace_record(trace::RuntimeTraceEventKind::MarketCallback,
                                                std::move(crossed_book));
  ...
  trace::RuntimeTraceSink one_sided{configured_runtime_policy_or_throw()};
  auto bid_only = create_market_callback_fields_or_throw();
  bid_only.best_ask.reset();
  REQUIRE(one_sided.append_trace_record(trace::RuntimeTraceEventKind::MarketCallback,
                                        std::move(bid_only)));
  auto ask_only = create_market_callback_fields_or_throw();
  ...
  auto zero_bid = create_market_callback_fields_or_throw();
  zero_bid.best_bid = create_price_or_throw(0, 0U);
  CHECK_FALSE(sink.validate_trace_record(trace::RuntimeTraceEventKind::MarketCallback, zero_bid));
  auto negative_ask = create_market_callback_fields_or_throw();
  negative_ask.best_ask = create_price_or_throw(-1, 0U);
  CHECK_FALSE(
      sink.validate_trace_record(trace::RuntimeTraceEventKind::MarketCallback, negative_ask));

  // Unknown event values and enum representations fail without consuming an ordinal.
  const auto unknown_kind = sink.append_trace_record(
      static_cast<trace::RuntimeTraceEventKind>(999U), create_market_callback_fields_or_throw());
  REQUIRE_FALSE(unknown_kind);
  CHECK(unknown_kind.error().context.field == "runtime_trace.kind");

  auto unknown_state = create_market_callback_fields_or_throw();
  unknown_state.state = static_cast<trace::RuntimeMarketState>(999U);
  const auto unknown_enum = sink.append_trace_record(trace::RuntimeTraceEventKind::MarketCallback,
                                                     std::move(unknown_state));
...
TEST_CASE("runtime trace capacity is preflighted without overwrite", "[trace][runtime][unit]") {
  ...
  const auto bounded_policy = create_runtime_policy_or_throw(6U);
  trace::RuntimeTraceSink sink{bounded_policy};
  CHECK(sink.capacity() == 6U);
  REQUIRE(sink.preflight_trace_append(6U));
  const auto empty_bytes = sink.encode_canonical_bytes();
  const auto empty_digest = sink.derive_digest();
  REQUIRE(empty_bytes);
  REQUIRE(empty_digest);
  const auto oversized_preflight = sink.preflight_trace_append(7U);
  ...
  CHECK(sink.encode_canonical_bytes().value() == empty_bytes.value());
  CHECK(sink.derive_digest().value() == empty_digest.value());

  // ++++++++++++++++++++++++++++++++++++++++
  // A partial prefix exposes the same first unavailable index while retaining every accepted byte.
  REQUIRE(sink.append_trace_record(trace::RuntimeTraceEventKind::InputDisposition,
                                   create_input_fields_or_throw()));
  const auto failed_preflight = sink.preflight_trace_append(6U);
  ...
  // ordinal.
  const auto rejected = sink.append_trace_record(trace::RuntimeTraceEventKind::MarketCallback,
                                                 trace::RuntimeTraceFields{});
  REQUIRE_FALSE(rejected);
  CHECK(rejected.error() ==
        model::DomainError::create_at_index(model::DomainErrorCode::TraceCapacityExceeded,
                                            "runtime_trace.records", 6U));
  CHECK(sink.record_count() == 6U);
...
TEST_CASE("runtime trace has stable canonical bytes", "[trace][runtime][golden]") {
  ...
  trace::RuntimeTraceSink first{configured_runtime_policy_or_throw()};
  trace::RuntimeTraceSink second{configured_runtime_policy_or_throw()};
  REQUIRE(first.append_trace_record(trace::RuntimeTraceEventKind::MarketCallback,
                                    create_market_callback_fields_or_throw()));
  REQUIRE(second.append_trace_record(trace::RuntimeTraceEventKind::MarketCallback,
                                     create_market_callback_fields_or_throw()));
  REQUIRE(first.append_trace_record(trace::RuntimeTraceEventKind::ReentryDetected,
                                    create_owner_reentry_fields_or_throw()));
  REQUIRE(second.append_trace_record(trace::RuntimeTraceEventKind::ReentryDetected,
                                     create_owner_reentry_fields_or_throw()));
  ...
  CHECK(bytes_to_hexadecimal(first_bytes.value()) == expected_bytes);
  CHECK(digest_to_hex(first_digest.value()) == expected_digest);
